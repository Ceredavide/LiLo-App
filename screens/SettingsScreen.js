  ...
  return (
    <View style={styles.containerSettings}>
      <Image
        ...
        source={{
          uri:
            "http://liloautogestito.ch/API/pic/impostazioni.png" +
            "#" +
            `${Math.random()
              .toString(36)
              .substring(2, 15) +
      ...
      <View style={styles.bottoniContainer}>
        ...
        >
          <Text style={styles.buttonText}>Termini e Condizioni</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => Alert.alert("Coming soon (Liam è lento)")}
          style={styles.buttonBirra}
        >
          <Text style={styles.buttonText}>Offrici una birra</Text>
        </TouchableOpacity>
